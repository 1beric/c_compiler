...
extern int yylex();
extern void yyerror();
extern void genCode(tnode *t, char *name);
...
static const yytype_uint16 yyrline[] =
    {
        0, 80, 80, 82, 84, 87, 86, 101, 104, 106,
        115, 115, 116, 120, 132, 133, 137, 138, 142, 143,
        148, 149, 150, 154, 155, 159, 163, 163, 164, 164,
        165, 169, 180, 194, 198, 199, 203, 209, 215, 221,
        245, 246, 247, 248, 249, 257, 258, 258, 262, 263,
        263, 267, 271, 272, 276, 277, 281, 282, 286, 287,
        291, 313, 314, 315, 316, 317, 318, 319, 320, 321,
        322, 326, 327, 328, 329, 330, 331, 332, 333, 334,
        335, 336, 337, 342, 366, 388, 399, 425, 451, 462,
        472, 499, 514, 515, 518};
#endif
...
#line 89 "parser.y" /* yacc.c:1646  */
  {
    ...
    /*
       ...
       */
#ifdef DEBUG
    genCode(currfnbodyTree, (yyvsp[-9].chptr));
#endif
    CleanupFnInfo();
  }
...
#line 137 "parser.y" /* yacc.c:1646  */
  {
    lptr = Attach((yyvsp[-2].idlistptr), (yyvsp[0].idlistptr));
    (yyval.idlistptr) = lptr;
  }
...
#line 142 "parser.y" /* yacc.c:1646  */
  {
    lptr = NewListNode((yyvsp[0].chptr), (yyvsp[-1].nval), false);
    (yyval.idlistptr) = lptr;
  }
...
#line 143 "parser.y" /* yacc.c:1646  */
  {
    lptr = NewListNode((yyvsp[-2].chptr), (yyvsp[-3].nval), true);
    (yyval.idlistptr) = lptr;
  }
